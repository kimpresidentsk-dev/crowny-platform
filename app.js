...
async function sendTokensByEmail(recipientEmail, amount, tokenType = 'CRNY') {
    ...
    try {
        ...
        const contracts = {
            'CRNY': '0xe56173b6a57680286253566B9C80Fcc175c88bE1',
            'FNC': '0x68E3aA1049F583C2f1701fefc4443e398ebF32ee',
            'CRFN': '0x396DAd0C7625a4881cA0cd444Cd80A9bbce4A054'
        };
        
        const contractAddress = contracts[tokenType];
        ...
        const account = web3.eth.accounts.privateKeyToAccount(userWallet.privateKey);
        ...
        // Send transaction
        const tx = await contract.methods.transfer(recipient.walletAddress, amountWei).send({
